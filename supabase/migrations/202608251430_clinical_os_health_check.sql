...
with required_objects(object_type, object_name, is_ready) as (
  values
    ...
    ('table','physical_examination_findings', to_regclass('public.physical_examination_findings') is not null),
    ...
    ('table','treatment_plans', to_regclass('public.treatment_plans') is not null),
