...
-- Chananya OPD Encounter Workflow
-- Source basis: OPD เวชกรรมไทยฉบับแก้ไข 7-8-69 (3 pages)
-- Adds encounter-snapshot history and treatment-session outcome records.
...
select
  'CHANANYA_OPD_ENCOUNTER_WORKFLOW_READY' as status,
  2 as modules_created;
