...
begin
  ...
  insert into public.ttm_diagnostic_contexts(
    ...
    season_pitsadan, zodiac_samutthan, practitioner_confirmed, confirmed_by, confirmed_at,
    knowledge_version, updated_at
  ) values (
    p_encounter_id, p_birth_constitution, p_present_constitution, p_ayu_samutthan, p_kala_samutthan,
    p_pradesa_samutthan, p_dosha_state, p_coordinate, p_mixed_coordinate, p_season_4, p_season_6,
    p_season_pitsadan, p_zodiac_samutthan, coalesce(p_practitioner_confirmed,false),
...
select 'CHANANYA_ATOMIC_TTM_DIAGNOSIS_READY' as status;
