...
assert.deepEqual(allScriptNames,['luopan-frame-guard.js','luopan-knowledge.js','luopan-astronomy.js','luopan.js','u-systesis.js']);
assert.match(html,/<script type="module" src="u-systesis\.js/);
