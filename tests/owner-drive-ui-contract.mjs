...
assert.match(html, /owner-control\.js\?v=cnyos-owner-google-20260906-setup-20260909"/, 'Owner Console must load the recovery-aware controller revision');
assert.match(html, /owner-control\.css\?v=cnyos-owner-google-20260906-setup-20260909"/, 'Owner recovery stylesheet must share the controller revision');
