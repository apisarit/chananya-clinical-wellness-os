...
assert.match(migration, /create table if not exists public\.line_oa_webhook_events/i);
...
assert.match(migration, /revoke all on public\.line_oa_webhook_events from public, anon, authenticated, service_role/i);
