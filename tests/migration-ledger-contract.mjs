...
const expectedPostBaselineMigrations = Object.freeze([
  ...
  Object.freeze({
    version: '20260922163445',
    name: 'link_appointment_encounter_idempotently',
    file: '20260922163445_link_appointment_encounter_idempotently.sql',
    sha256: '7717bd4b1d276688f53cd62c1010c16e93fc893bfa091b79ffc31ac4854a587c'
  }),
  Object.freeze({
Object.freeze({
  version: '20260923033743',
  name: 'foundation_realtime',
  file: '20260923033743_foundation_realtime.sql',
  sha256: '9906848dce71db2e91fb369a364aff528dde2fe127ac69474de6bb5390c17401'
}),
Object.freeze({
  version: '20260923084317',
...
assert.equal(repositoryEntries.length, 55, 'repository must contain the 55-file source chain');
assert.deepEqual(
  repositoryEntries,
  [...repositoryEntries].sort((a, b) => a.file < b.file ? -1 : a.file > b.file ? 1 : 0)
);
assert.deepEqual(
  repositoryEntries.slice(-10),
  expectedPostBaselineMigrations,
  'migration ledger tail must bind treatment-service, appointment and Foundation realtime migrations'
);
