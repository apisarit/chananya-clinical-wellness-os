// U Synthesize is the owner's chosen display spelling. Internal ids remain
// `u-synthesise` for backwards-compatible routes and feature flags.
...
export const identity = deepFreeze({
  name: 'U Synthesize', id: 'u-synthesise', version: '0.3.1', status: 'foundation_draft',
...
export const sources = deepFreeze({
  ...
  owner: {kind: 'project_convention', title: 'คำยืนยันผู้ใช้: กาลสมุฏฐาน 12 ชั่วโมง × 2 รอบ; วงปีเริ่มเมษายน; ชื่อ U Synthesize', recorded: '2026-09-05'},
