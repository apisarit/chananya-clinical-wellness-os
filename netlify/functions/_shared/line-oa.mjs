...
export function buildLineReplyMessages(action, options = {}) {
  ...
  const messages = {
    ...
    card: cardUrl
      ? 'เปิดบัตรผู้รับบริการผ่านปุ่มด้านล่าง จากนั้นกรอกรหัสใช้ครั้งเดียวที่เจ้าหน้าที่ออกให้หลังค้นหา HN เพื่อเชื่อมบัญชีและสร้าง QR ซึ่งหมดอายุภายใน 90 วินาที หากไม่มีมือถือสามารถแจ้ง HN กับเจ้าหน้าที่ได้ตามปกติ ระบบไม่รับ HN ผ่านแชตนี้'
